# PHANTOM — Design Specification

> This document contains the full technical design, threat model, security properties, implementation plan, and references.
> For the overview and quickstart, see [README.md](../README.md).
> For hardware mapping and ESP32 porting, see [ARCHITECTURE.md](../ARCHITECTURE.md).
